...
def clean_text(text):
    """
    Removes unsupported characters (like emojis or smart quotes) 
    that crash the PDF generator.
    """
    ...
    replacements = {
        ...
        '\u201c': '"', '\u201d': '"', # Smart double quotes
        '\u2013': '-', '\u2014': '-', # Em-dashes
        '\u2032': "'",                # Prime symbol (The specific error you saw)
        '\u2026': "..."               # Ellipsis
    }
    for char, replacement in replacements.items():
        text = text.replace(char, replacement)
        
    # Final safety net: remove anything else not in Latin-1
...
def generate_pdf(company: Company):
    ...
    # Apply clean_text() to ALL inputs
